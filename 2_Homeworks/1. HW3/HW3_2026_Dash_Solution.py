...
class CouponDispenser:
    ...
    def issue_coupon(self, name):
        ...
        choice = random.randrange(len(self.coupon_cards))
        self.customer_roster.append(name)
        self.issued_indices.append(choice)
        return self.coupon_cards[choice]
    ...
    def distribute_session(self):
        ...
        while True:
            ...
            prompt = (
                f"Round {round_num} - Enter a name (or a comma-separated list), "
